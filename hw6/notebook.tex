...
{\color{incolor}In [{\color{incolor}1}]:} \PY{n+nb}{rand}\PY{p}{(}\PY{l+s}{\PYZsq{}}\PY{l+s}{seed\PYZsq{}}\PY{p}{,} \PY{l+m+mi}{314}\PY{p}{)}\PY{p}{;}
...
\textbf{Call to CVX:}
    ...
    \begin{Verbatim}[commandchars=\\\{\}]
{\color{incolor}In [{\color{incolor}8}]:} \PY{n}{cvx\PYZus{}begin}
